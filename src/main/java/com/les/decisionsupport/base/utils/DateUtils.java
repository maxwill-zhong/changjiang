package com.les.decisionsupport.base.utils;
...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils
{
     ...
     * @return
     */
    public static String parseString(Object date) {
        if (date == null) {
            return null;
        }
        try {
     ...
     * @return
     */
    public static String getBeforeMonth(String sdate)  {
        try {
            Date currentDate = getDate(sdate);
            ...
            // 输出上个月的时间
            return getDateString(lastMonthDate);
        } catch (Exception e) {
            return "";
        }
    }
    ...
    public static void main(String[] args) {
        System.out.println(getBeforeMonth(getNow()).substring(0, 7));
    }
}
