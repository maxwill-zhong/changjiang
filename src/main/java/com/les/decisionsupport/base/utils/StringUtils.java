...
import com.les.decisionsupport.base.utils.text.StrFormatter;
...
public class StringUtils extends org.apache.commons.lang3.StringUtils
{
    ...
    public static boolean isValid(String value) {
        ...
        String[] urls = value.indexOf(";") > 0 ? value.split(";") : value.split(",");
        for (String url : urls) {
            String patternString = "$|^(?:https?|ftp):\\/\\/\\S+(?:\\.(?:jpg|jpeg|gif|png|webp|bmp))";
